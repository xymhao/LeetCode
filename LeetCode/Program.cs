...
namespace LeetCode
{
    ...
    class Program
    {
        ...
        private static async void GetData()
        {
            ...
            var response = await client.GetAsync("http://services.odata.org/Northwind/Northwind.svc/Regions");
        ...
        public static void UDPTest()
        {
            ...
            udp.Send(sendBytes, sendBytes.Length, "SomeEchoServer.net", 7);
            IPEndPoint endPoint = new IPEndPoint(0, 0);
            byte[] rcvBytes = udp.Receive(ref endPoint);
