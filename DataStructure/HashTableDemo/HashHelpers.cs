        ...
        public static ConditionalWeakTable<object, SerializationInfo> SerializationInfoTable
        {
            get
            {
                if (HashHelpers.s_serializationInfoTable == null)
                    Interlocked.CompareExchange<ConditionalWeakTable<object, SerializationInfo>>(
                        ref HashHelpers.s_serializationInfoTable, new ConditionalWeakTable<object, SerializationInfo>(),
                        (ConditionalWeakTable<object, SerializationInfo>) null);
